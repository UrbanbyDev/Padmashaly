...
import com.urbantech.AsyncTask.LoadComments;
import com.urbantech.adapter.AdapterCommentEndless;
...
import com.urbantech.interfaces.CommentListener;
            ...
            public void onClick(View v) {
                if (!Constant.isLogged) {
                    ...
                    if (methods.isNetworkAvailable()) {
                        loadPostComment();
//                        Toast.makeText(getActivity(), "This function is disabled in demo app", Toast.LENGTH_SHORT).show();
                    } else {
