...
public class NewsByCatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(Constant.pushTitle);
    ...
    private SearchView.OnQueryTextListener queryTextListener = new SearchView.OnQueryTextListener() {
        ...
        public boolean onQueryTextSubmit(String s) {
            if (!s.trim().equals("")) {
                Intent intent = new Intent(NewsByCatActivity.this, ActivitySearch.class);
    ...
    private void loadNativeAds() {
        if (Constant.isNativeAd && arrayList.size() >= 10) {
            AdLoader.Builder builder = new AdLoader.Builder(NewsByCatActivity.this, Constant.nativeAdID);
    ...
    private void setAdapter() {
        if (!isScroll) {
            myAdapter = new AdapterNewsByCat(NewsByCatActivity.this, arrayList,false);
    ...
    public void onBackPressed() {
        if (Constant.pushPostID.equals("0")) {
            ...
            Intent intent = new Intent(NewsByCatActivity.this, MainActivity.class);
            startActivity(intent);
            NewsByCatActivity.this.finish();
        }
    }
}