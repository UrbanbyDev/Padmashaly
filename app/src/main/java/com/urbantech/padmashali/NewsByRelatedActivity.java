...
public class NewsByRelatedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getString(R.string.related_news));
    ...
    private SearchView.OnQueryTextListener queryTextListener = new SearchView.OnQueryTextListener() {
        ...
        public boolean onQueryTextSubmit(String s) {
            if (!s.trim().equals("")) {
                Intent intent = new Intent(NewsByRelatedActivity.this, ActivitySearch.class);
    ...
    private void loadNativeAds() {
        if (Constant.isNativeAd && arrayList.size() >= 10) {
            AdLoader.Builder builder = new AdLoader.Builder(NewsByRelatedActivity.this, Constant.nativeAdID);
    ...
    private void setAdapter() {
        if (!isScroll) {
            myAdapter = new AdapterNewsByCat(NewsByRelatedActivity.this, arrayList,false);
    ...
    public void onBackPressed() {
        if (Constant.pushPostID.equals("0")) {
            ...
            Intent intent = new Intent(NewsByRelatedActivity.this, MainActivity.class);
            startActivity(intent);
            finish();
        }
    }
